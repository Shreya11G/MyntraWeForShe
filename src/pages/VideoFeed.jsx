...
// import api from "../api/index"; // adjust the path if needed
...
// 	const fetchVideos = async () => {
// 		try {
// 			const res = await api.get("/video-feed"); // use centralized client
// 			const vids = (res?.data || []).reverse();
// 			setVideos(vids.length > 0 ? vids : FALLBACK_VIDEOS);
// 		} catch (err) {
// 			console.error("Video feed fetch failed:", err);
...
// 								<img
// 									src={v.avatar || fallbackVideos[0].avatar}
// 									alt="avatar"
// 									className="reels-avatar"
// 								/>
// 								<span className="reels-username">
// 									{v.username || "@myntrauser"}
// 								</span>
// 							</div>
// 							<div className="video-caption reels-caption">{v.caption}</div>
// 							<div className="reels-overlay">
// 								<button className="reels-btn like">
// 									<FontAwesomeIcon icon={faHeart} />
// 								</button>
// 								<button
// 									className="reels-btn comment"
...
// 									<div key={i}>
// 										<span className="reels-comment-user">{c.user}</span>
// 										{c.text}
// 									</div>
// 								))}
// 							</div>
...
const VideoFeed = () => {
	...
	useEffect(() => {
		// directly set fallback since no backend
		setVideos(fallbackVideos);
	}, []);
					...
					<div
						...
						<div className="reels-userbar">
							<img
								...
								className="reels-avatar"
							/>
							<span className="reels-username">{v.username}</span>
						</div>
						<div className="video-caption reels-caption">{v.caption}</div>
						<div className="reels-overlay">
							<button className="reels-btn like">
