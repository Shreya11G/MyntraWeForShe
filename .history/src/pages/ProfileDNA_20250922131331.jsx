	...
	const data = {
		...
		return (
			<div className="profile-dna-container">
				...
				<div className="dna-card" style={{ marginBottom: "2rem" }}>
					<div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 12 }}>
						<h3 style={{ margin: 0, fontSize: "1.2rem", fontWeight: 900, color: "#180433ff" }}>
							{region} Region Trendiest Fashion
						</h3>
						<select
							style={{ marginLeft: 16, padding: "0.3rem 0.7rem", borderRadius: 8, border: "1px solid #a259ff", fontWeight: 600 }}
							value={selectedRegion}
							onChange={e => setSelectedRegion(e.target.value)}
						>
							<option value="">View other region trends...</option>
							{allRegions.map((r) => (
