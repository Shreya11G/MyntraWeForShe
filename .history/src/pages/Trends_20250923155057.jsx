import React, { useState } from "react";import React, { useState } from "react";import React, { useState } from "react";import React, { useState, useEffect } from "react";import React, { useState, useEffect } from "react";
...
const Trends = () => {import "./Trends.css";import "./ProfileDNA.css";
  ...
  const regionalTrends = {const Trends = () => {import "./Trends.css";import "./ProfileDNA.css";import "./ProfileDNA.css";

    Delhi: {

      women: ["Sarees with modern prints", "Chunky sneakers", "Indo-western fusion"],  const [selectedRegion, setSelectedRegion] = useState("");
    ...
    Mumbai: {  const regionalTrends = {
      ...
      men: ["Linen shirts", "Printed shorts", "Slip-on loafers"],    Delhi: {const regionalTrends = {import "./Trends.css";import "./Trends.css";
    ...
    Bangalore: {
      ...
      women: ["Layered kurtis", "Denim jackets", "Sneaker boots"],      men: ["Streetwear jackets", "White sneakers", "Relaxed fit denims"],  Delhi: {

      men: ["Techwear", "Plaid shirts", "Chelsea boots"],

      neutral: ["Athleisure joggers", "Smart watches", "Unisex backpacks"]      neutral: ["Oversized tees", "Bucket hats", "Pastel colors"]

    },

    Default: {    },    women: ["Sarees with modern prints", "Chunky sneakers", "Indo-western fusion"],

      women: ["Trendy tops", "Classic jeans", "Statement bags"],

      men: ["Casual shirts", "Slim-fit jeans", "Sneakers"],    Mumbai: {
  ...
  // Smart shopping insights - This is what you wanted instead of unhelpful graphs!

  const shoppingInsights = {      neutral: ["Tote bags", "Minimalist jewelry", "Graphic tees"]    neutral: ["Oversized tees", "Bucket hats", "Pastel colors"]// --- Regional Fashion Trends Mock Data ---// --- Regional Fashion Trends Mock Data ---
    ...
    Delhi: {
      ...
      price_changes: ['+5%', '+15%', '+25%', '+10%', '+8%'],    Bangalore: {  },

      why: ['Back to work season', 'Festive season starting', 'Wedding season peak', 'Winter clothing demand', 'Holiday parties'],

      shopping_tips: [      women: ["Layered kurtis", "Denim jackets", "Sneaker boots"],

        'Buy cotton kurtas now before festive price hike',

        'Wait for Diwali sales for better deals',      men: ["Techwear", "Plaid shirts", "Chelsea boots"],  Mumbai: {const regionalTrends = {const regionalTrends = {
    ...
    Mumbai: {    Default: {
      ...
      trending_items: ['Monsoon Wear', 'Casual Shirts', 'Party Dresses', 'Light Jackets', 'Ethnic Fusion'],      women: ["Trendy tops", "Classic jeans", "Statement bags"],    men: ["Linen shirts", "Printed shorts", "Slip-on loafers"],  Delhi: {  Delhi: {
      ...
      shopping_tips: [
        ...
        'Great discounts on monsoon wear right now!',      neutral: ["Unisex hoodies", "Caps", "Crossbody bags"]    neutral: ["Tote bags", "Minimalist jewelry", "Graphic tees"]
        ...
        'Party wear prices peak in December'  };  },    women: ["Sarees with modern prints", "Chunky sneakers", "Indo-western fusion"],    women: ["Sarees with modern prints", "Chunky sneakers", "Indo-western fusion"],
    ...
    Bangalore: {
      ...
      months: ['Aug', 'Sep', 'Oct', 'Nov', 'Dec'],  const shoppingInsights = {  Bangalore: {

      trending_items: ['Tech Casual', 'Hoodies', 'Denim Jackets', 'Boots', 'Sweaters'],

      price_changes: ['+3%', '+8%', '+12%', '+20%', '+15%'],    Delhi: {

      why: ['Work from office', 'Weather getting cool', 'Layering season', 'Winter clothing peak', 'Holiday shopping'],

      shopping_tips: [      months: ['Aug', 'Sep', 'Oct', 'Nov', 'Dec'],    women: ["Layered kurtis", "Denim jackets", "Sneaker boots"],    men: ["Streetwear jackets", "White sneakers", "Relaxed fit denims"],    men: ["Streetwear jackets", "White sneakers", "Relaxed fit denims"],

        'Tech-wear demand rising with office return',

        'Hoodies becoming weather essentials',      trending_items: ['Cotton Kurtas', 'Festive Lehengas', 'Winter Jackets', 'Wedding Sarees', 'Party Wear'],

        'Layer up - denim jackets trending now',

        'Boot prices highest in peak winter',      price_changes: ['+5%', '+15%', '+25%', '+10%', '+8%'],    men: ["Techwear", "Plaid shirts", "Chelsea boots"],
    ...
    Default: {      shopping_tips: [    neutral: ["Athleisure joggers", "Smart watches", "Unisex backpacks"]    neutral: ["Oversized tees", "Bucket hats", "Pastel colors"]          <div style={{ marginTop: '2rem' }}>

      months: ['Aug', 'Sep', 'Oct', 'Nov', 'Dec'],

      trending_items: ['Casual Wear', 'T-shirts', 'Jeans', 'Sneakers', 'Accessories'],        'Buy cotton kurtas now before festive price hike',

      price_changes: ['+2%', '+5%', '+8%', '+6%', '+10%'],

      why: ['General trends', 'Season change', 'Festival preparations', 'Cool weather', 'Year-end shopping'],        'Wait for Diwali sales for electronics',  },

      shopping_tips: [

        'Good time for basic wardrobe refresh',        'Stock up on winter wear early to avoid rush',

        'T-shirt prices remain stable',

        'Jeans see modest price increases',        'Book tailors now for wedding season',  Default: {  },        <h3 style={{ fontWeight: 700, marginBottom: '1rem', color: '#333' }}>

        'Sneaker sales before festive season',

        'Accessory prices peak during holidays'        'Party wear will be cheaper post New Year'
  ...
  const futurePredictions = {    Mumbai: {    men: ["Casual shirts", "Slim-fit jeans", "Sneakers"],  Mumbai: {          💡 Smart Shopping Insights
    ...
    Delhi: [
      ...
      {      months: ['Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
        ...
        trend: "🪔 Festive Ethnic Surge",      trending_items: ['Monsoon Wear', 'Casual Shirts', 'Party Dresses', 'Light Jackets', 'Ethnic Fusion'],    neutral: ["Unisex hoodies", "Caps", "Crossbody bags"]

        reason: "Diwali and wedding season driving demand for lehengas, sarees, and sherwanis",

        categories: ["Lehengas", "Heavy Sarees", "Sherwanis", "Mojaris", "Kundan Jewelry"]      price_changes: ['-10%', '+5%', '+12%', '+8%', '+15%'],
    ...
    Mumbai: [
      ...
      {      shopping_tips: [
        ...
        trend: "🌊 Monsoon-to-Winter Transition",        'Great discounts on monsoon wear now',};
    ...
    Bangalore: [
      ...
      {        'Light jackets in demand, buy early',
        ...
        trend: "💻 Tech-Formal Fusion",        'Party wear prices peak in December'const shoppingInsights = {
    ...
    Default: [
      ...
      {    Default: {
        ...
        trend: "🍂 Autumn Essentials",      months: ['Aug', 'Sep', 'Oct', 'Nov', 'Dec'],    months: ['Aug', 'Sep', 'Oct', 'Nov', 'Dec'],

        reason: "Seasonal transition driving demand for layering and earth tone clothing",

        categories: ["Cardigans", "Ankle Boots", "Earth Tones", "Scarves"]      trending_items: ['Casual Wear', 'T-shirts', 'Jeans', 'Sneakers', 'Accessories'],
  ...
  const region = selectedRegion || "Default";      shopping_tips: [    price_changes: ['+5%', '+15%', '+25%', '+10%', '+8%'],

  const trends = regionalTrends[region];

  const insights = shoppingInsights[region] || shoppingInsights.Default;        'Good time for basic wardrobe refresh',
  ...
  const renderActionableInsights = () => (
    ...
    <div className="trends-grid">        'Jeans see modest price increases',

      <div className="trends-chart-container">

        <div className="chart-title">        'Sneaker sales before festive season',    shopping_tips: [
        ...
        <div style={{ padding: '16px 0' }}>      ]      'Buy cotton kurtas now before festive price hike',    women: ["Layered kurtis", "Denim jackets", "Sneaker boots"],      </div>versized tees", "Bucket hats", "Pastel colors"]
          ...
          {insights.months.map((month, index) => {
            ...
            return (  };      'Wait for Diwali sales for electronics',
              ...
              <div key={index} style={{ 
                ...
                alignItems: 'center',  const futurePredictions = {      'Stock up on winter wear early to avoid rush',    men: ["Techwear", "Plaid shirts", "Chelsea boots"],  },
                ...
                borderRadius: '8px',      {      'Book tailors now for wedding season',
                ...
                <div>
                  ...
                  <div style={{ fontWeight: '700', fontSize: '1rem' }}>{month} 2025</div>        trend: "🪔 Festive Ethnic Surge",      'Party wear will be cheaper post New Year'    neutral: ["Athleisure joggers", "Smart watches", "Unisex backpacks"]  Mumbai: {

                  <div style={{ fontSize: '0.85rem', color: '#666' }}>

                    {insights.why[index]}        reason: "Diwali and wedding season driving demand for lehengas, sarees, and sherwanis",

                  </div>

                </div>        categories: ["Lehengas", "Heavy Sarees", "Sherwanis", "Mojaris", "Kundan Jewelry"]    ]
