...
export default function DNAQuests() {
	...
	const [animatePoints, setAnimatePoints] = useState(false);
		...
		const defaultQuests = [
			{
				...
				active: true,
				target_trait: 10,
				requirements: [{ type: "buy_items", count: 5, completed: 0 }],
			...
			},
			{
				...
				active: true,
				target_trait: 6,
				requirements: [{ type: "view_collections", count: 3, completed: 0 }],
		...
		const [quests, setQuests] = useState(() => {
			...
			if (!saved || lastRefresh !== thisMonday) {
				localStorage.setItem("dna_quests", JSON.stringify(defaultQuests));
				localStorage.setItem("dna_quests_last_refresh", thisMonday);
			...
			<div className="dna-quests-container">
				<div className="dna-quests-header">
					...
					<div style={{
						...
						<span role="img" aria-label="refresh">🔄</span> Quests refresh every Monday! Complete as many as you can each week to maximize your DNA Points.
					</div>
