...
const mockPosts = [
  {
    ...
    mediaUrl: require("../assets/Want this look Comment ‘LOOK’ below🔗....Follow and comment for links💌....#powerlook #aesthetic.mp4"),
    mediaType: "video",
  ...
  {
    ...moreMockPosts[0],
    mediaUrl: require("../assets/type LINK to get exact-similar links...#myntra #myntrafinds #womenfashion.mp4"),
    mediaType: "video",
    products: [3], // DENIM X
  },
  {
    ...moreMockPosts[1],
    mediaUrl: require("../assets/Follow and Comment for the link 🖇️ (₹530 price was only valid till end of Myntra birthday sale,.mp4"),
    mediaType: "video",
    products: [1], // Boho Jacket
  },
  {
