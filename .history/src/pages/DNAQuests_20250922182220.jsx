...
export default function DNAQuests() {
	...
	// Deterministically shuffle quests based on today's date
	function getDailyQuests(allQuests, num = 3) {
	...
	const [quests, setQuests] = useState(() => {
		...
		if (!saved || lastRefresh !== today) {
			const todaysQuests = getDailyQuests(defaultQuests, 3);
			localStorage.setItem("dna_quests", JSON.stringify(todaysQuests));
