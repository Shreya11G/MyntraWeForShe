  ...
  Delhi: {
    ...
    men: ["Streetwear jackets", "White sneakers", "Relaxed fit denims"],
        ...
        <p style={{ color: '#666', marginBottom: '1rem' }}>
          Real data to help you shop smarter and save money:
        </p>
        {renderUsefulInsights()}
      </div>versized tees", "Bucket hats", "Pastel colors"]
  },
  Mumbai: {
    ...
    <div className="trends-grid">
      <div className="trends-chart-container">
        ...
        <div style={{ fontSize: '0.85rem', color: '#666', marginTop: '12px' }}>
          💡 <strong>Tip:</strong> Buy when prices drop, avoid peak months
        </div>
      </div>
      ...
      <div className="trends-chart-container">
        <div className="chart-title">
          <span className="chart-icon">🔥</span>
          What's Actually Selling Each Month
        </div>
        <div style={{ padding: '16px 0' }}>
          {chartData.months.map((month, index) => (
            <div key={index} style={{ 
              ...
              <div style={{ 
                background: 'linear-gradient(90deg, #a259ff, #ff69b4)',
                color: 'white',
                padding: '4px 12px',
                borderRadius: '16px',
                ...
                🛍️ {chartData.trending_items[index]}
              </div>
              <div style={{ fontSize: '0.85rem', color: '#666', marginTop: '4px' }}>
                Why: {chartData.why[index]}
              </div>
            </div>
          ))}
        </div>
