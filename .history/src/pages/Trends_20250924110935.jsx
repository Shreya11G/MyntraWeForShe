  ...
  const renderTrendBarChart = () => (
    <div className="trends-chart-container">
      <div className="chart-title">
        ...
        Fashion Trend History - Last 7 Months
      </div>
      ...
      <div style={{
        ...
        <strong>Key Insights for {region}:</strong><br/>
        • <strong>March-April:</strong> Spring transition saw steady growth<br/>
        • <strong>May-June:</strong> Summer styles gaining momentum<br/>
        • <strong>July:</strong> Peak season for most aesthetics<br/>
        • <strong>August-September:</strong> Preparing for festive season
      </div>
    </div>
  );
    ...
    <div className="trends-container">
      ...
      <div style={{ marginTop: "2rem" }}>
        <h3 style={{ fontWeight: 700, marginBottom: "1rem", color: "#333" }}>
          📊 Complete Trend Analytics - Historical Data & Future Predictions
        </h3>
        <p style={{ color: "#666", marginBottom: "1rem" }}>
          Data-driven insights showing fashion trends over the past 7 months with AI-powered future predictions
        </p>
